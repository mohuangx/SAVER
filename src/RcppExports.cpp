...
RcppExport SEXP _SAVER_calc_abk(SEXP ySEXP, SEXP muSEXP, SEXP sfSEXP, SEXP typeSEXP, SEXP sampSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(calc_abk(y, mu, sf, type, samp));
...
RcppExport SEXP _SAVER_set_zero_if_below(SEXP xSEXP, SEXP tSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::sp_mat >::type x(xSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type t(tSEXP);
    rcpp_result_gen = Rcpp::wrap(set_zero_if_below(x, t));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_SAVER_calc_abk", (DL_FUNC) &_SAVER_calc_abk, 5},
    ...
    {"_SAVER_set_zero_if_below", (DL_FUNC) &_SAVER_set_zero_if_below, 2},
    {NULL, NULL, 0}
};
